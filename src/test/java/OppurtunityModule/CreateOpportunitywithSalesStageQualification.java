...
public class CreateOpportunitywithSalesStageQualification extends BaseClass {
	@Test
	public  void salesstagequalification() throws Throwable {
	

		driver.findElement(By.xpath("//a[@href='index.php?module=Potentials&action=index']")).click();
		driver.findElement(By.xpath("//img[@title='Create Opportunity...']")).click();
		ExcelUtility eu=new ExcelUtility();
		driver.findElement(By.xpath("//input[@name='potentialname']")).sendKeys(eu.excelutilty("Sheet1", 13, 2));
